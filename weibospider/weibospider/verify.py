...
class Yundama():
    def __init__(self, username, password, app_id='3918', app_key='7f090cb6363673244074d5722ed14195', api_url='http://api.yundama.com/api.php'):
        self.username = username
        self.password = password
        self.app_id = str(app_id) if not isinstance(app_id, str) else app_id
        self.app_key = app_key
        self.api_url = api_url
        print('UserName:{}  Balance:{}'.format(self.username,self.balance()))
